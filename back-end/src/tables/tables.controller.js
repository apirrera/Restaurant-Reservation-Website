...
/**
 * Checks for pre-existing tables with table ID
 */
...
/**
 * Valids that the table can seat based on reservation id also that the table isn't already seated
 */
...
/**
 * Valids if Table can seat the amount of people
 */
