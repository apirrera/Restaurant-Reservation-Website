...
//MIDDLEWARE VALIDATORS SECTION
/**
 * Checks for existing Reservation ID
 */
...
/**
 * Checks form data for new Reservation
 */
...
/**
 * Validates Correct Date - Closed on Tuesdays and can only be set for the future
 */
...
/**
 * Valids that the time is current and within business hours
 */
...
/**
 * Validates form data for update
 */
